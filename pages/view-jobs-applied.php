                        ...
                        <div class="panel-body">
                             <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php
										$sql = "SELECT * FROM jobs_applied where student_id=?";
										$pds=$pdo->prepare($sql);
										$pds->execute(array($student_id));
											while($row = $pds->fetch()) {
												...
												echo "<td>".$row3['job_responsibilities']."</td>";
												echo "<td>".$row3['job_requirements']."</td>";
												echo "<td>".$row3['job_salary']."</td>";		
												...
												echo "<td><a href=\"delete-jobs-applied.php?id=$row[applied_id]\">Delete</a></td>";
											}
											?>
                                    </tbody>
                                </table>
