                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
										...
										$row = $pds->fetch();
												...
												//echo "<td>".$row1['c_website']."</td>";
												echo "<td>".$row['job_description']."</td>";
												echo "<td>".$row['job_responsibilities']."</td>";
												echo "<td>".$row['job_requirements']."</td>";
												echo "<td>".$row['job_salary']."</td>";			
												echo "<td><a href=\"apply-for-job.php?job_id=$row[job_id]&company_id=$row[company_id]\" onClick=\"return confirm('Are you sure you want to apply?')\">Interested</a></td>";
											?>
                                    </tbody>
                                </table>
