...
if (isset($_POST["submit2"])) {
        ...
        if ($validate->passed()) {
			...
			try {
                $user->insert_education_detail(array(
                    'student_id' => Input::get('student_id1'),
...
if (isset($_POST["submit3"])) {
        ...
        if ($validate->passed()) {
			...
			try {
                $user->insert_education_detail(array(
                    'student_id' => Input::get('student_id2'),
							...
							<div id="myModal2" class="modal fade" role="dialog">
								...
								<!-- Modal content-->
									...
									<form action="" method="post">
										...
										<input type="text" maxlength="9" class="form-control" id="student_id1" name="student_id1" placeholder="Student ID" value="<?php echo escape(Input::get('student_id')); ?>" required>
										</div>
										<div class="form-group">
							...
							<div id="myModal3" class="modal fade" role="dialog">
								...
								<!-- Modal content-->
									...
									<form action="" method="post">
										...
										<input type="text" maxlength="9" class="form-control" id="student_id2" name="student_id2" placeholder="Student ID" value="<?php echo escape(Input::get('student_id')); ?>" required>
										</div>
										<div class="form-group">
