                        ...
                        <div class="panel-body">
                             <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php
										$sql = "SELECT * FROM student_hired order by hired_id";
										$pds=$pdo->prepare($sql);
										$pds->execute(array());
											while($row = $pds->fetch()) {
												...
												$row1 = $pds1->fetch();
												$sql3 = "SELECT * FROM personal_information where student_id=?";
												...
												echo "<td>".$row['job_position_group']."</td>";
												...
												echo "<td><a href=\"delete-student-hired.php?id=$row[hired_id]\">Delete</a></td>";
											}
											?>
                                    </tbody>
                                </table>
