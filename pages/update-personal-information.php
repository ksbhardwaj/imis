...
$sql = "SELECT * FROM personal_information ORDER BY student_id";
$pds=$pdo->prepare($sql);
$pds->execute(array());
?>
<!DOCTYPE html>
                                    ...
                                    <tbody>
                                        <?php
											while($row = $pds->fetch()) { 		
												...
												echo "<td><a href=\"edit-record-personal.php?id=$row[student_id]\">Edit</a> | <a href=\"delete-record-personal.php?id=$row[student_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
											}
											?>
                                    </tbody>
                                </table>
