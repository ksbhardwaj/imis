...
$sql = "SELECT * FROM education_detail ORDER BY student_id";
$pds=$pdo->prepare($sql);
$pds->execute(array());
?>
<!DOCTYPE html>
                                    ...
                                    <tbody>
                                        <?php
											while($row = $pds->fetch()) { 		
												...
												echo "<td>".$row['certifications_body']."</td>";
												echo "<td><a href=\"edit-record-education.php?id=$row[education_id]&&e_name=$row[education_name]\">Edit</a> | <a href=\"delete-record-education.php?id=$row[education_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
											}
											?>
                                    </tbody>
                                </table>
