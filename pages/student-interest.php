                        ...
                        <div class="panel-body">
                             <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php
										$sql = "SELECT * FROM jobs_applied order by applied_id";
										$pds=$pdo->prepare($sql);
										$pds->execute(array());
											while($row = $pds->fetch()) {
												...
												$row1 = $pds1->fetch();
												$sql2 = "SELECT * FROM personal_information where student_id=?";
												...
												//echo "<td><a href=\"job-detail.php?job_id=$row[job_id]\">Details</a></td>";
											}
											?>
                                    </tbody>
                                </table>
