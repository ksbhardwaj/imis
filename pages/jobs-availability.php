...
if (isset($_POST["submit0"])) {
            $user = new User();
            try {
                $user->insert_jobs_availability(array(
                    'company_id' => Input::get('SelectCompany'),
                    'job_description' => Input::get('InputDescription'),
					'job_responsibilities' => Input::get('InputResponsibilities'),
					'job_requirements' => Input::get('InputRequirements'),
					'job_salary' => Input::get('InputSalary'),
                ));
				$success = "Successful";
            } catch(Exception $e) {
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			...
			<h1 class="page-header">imis - Internship Information Management System</h1>
                <div class="col-lg-6">
					<h3>Insert job openings here.</h3>
						...
						<form action="" method="post" class="form-group">
								...
								?>
								  ...
								  <div class="form-group">
										...
										<textarea name="InputDescription" rows="3" cols="85"></textarea>
										</div>
								  <div class="form-group">
										<label for="InputResponsibilities">Responsibilities</label><br>
										<textarea name="InputResponsibilities" rows="3" cols="85"></textarea>
										</div>
								  <div class="form-group">
										<label for="InputRequirements">Requirements</label><br>
										<textarea name="InputRequirements" rows="3" cols="85"></textarea>
										</div>
								  <div class="form-group">
