...
$sql = "SELECT * FROM work_experience ORDER BY student_id";
$pds=$pdo->prepare($sql);
$pds->execute(array());
?>
<!DOCTYPE html>
                                    ...
                                    <tbody>
                                        <?php
											while($row = $pds->fetch()) { 		
												...
												echo "<td><a href=\"edit-record-work.php?id=$row[work_id]\">Edit</a> | <a href=\"delete-record-work.php?id=$row[work_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
											}
											?>
                                    </tbody>
                                </table>
