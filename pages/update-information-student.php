                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody><br><br>
                                        ...
                                        <?php		
												...
												echo "<td><a href=\"edit-record-personal1.php?id=$row1[student_id]\">Edit</a> | <a href=\"delete-record-personal1.php?id=$row1[student_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
											?>
                                    </tbody>
                                </table>
                                    ...
                                    <tbody>
                                        <?php
											while($row2 = $pds2->fetch()) { 		
												...
												echo "<td><a href=\"edit-record-education1.php?id=$row2[education_id]&&e_name=$row2[education_name]\">Edit</a> | <a href=\"delete-record-education1.php?id=$row2[education_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
											}
											?>
                                    </tbody>
                                </table>
                                    ...
                                    <tbody>
                                        <?php
											while($row3 = $pds3->fetch()) { 		
												...
												echo "<td><a href=\"edit-record-work1.php?id=$row3[work_id]\">Edit</a> | <a href=\"delete-record-work1.php?id=$row3[work_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
											}
											?>
                                    </tbody>
                                </table>
